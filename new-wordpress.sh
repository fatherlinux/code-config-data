...
mkdir -p $1/code $1/config $1/data

# Populate the code directory with the laest wordpress
wget wget https://wordpress.org/latest.zip -O $1/code/wordpress.zip
unzip -o $1/code/wordpress.zip -d $1/code/
rm -f $1/code/wordpress.zip
chown -R 48.48 $1/code/wordpress

# Populate the config directory with the right files

## Create Apache configuration file

cat > $1/config/$1.conf <<EOF
<VirtualHost *:80>
	...
	ServerAlias www.$1
        ...
        ErrorLog /var/log/httpd/$1_errors.log
...
-v /srv/$1/data/wp-content:/var/www/html/$1/wp-content:Z \
-v /srv/$1/data/logs/httpd:/var/log/httpd:Z \
-v /srv/$1/data/mariadb/:/var/lib/mysql:Z \
--tmpfs /etc \
--tmpfs /var/log/ \
--tmpfs /var/tmp \
...
mkdir -p $1/data/logs/httpd

## Create Mariadb directory
mkdir -p $1/data/mariadb
chown 27.27 $1/data/mariadb
